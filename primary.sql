...
CREATE OR REPLACE VIEW msp_payroll_category AS
SELECT 
...
CREATE OR REPLACE VIEW msp_food_average AS
SELECT 
...
SELECT 
	...
	p2.price AS price, 
	p2.product AS product, 
	p2.quantity AS quantity, 
	p2.unit AS unit
FROM msp_payroll_category p1
LEFT JOIN msp_food_average p2 ON p1.payroll_year = year(p2.date_from);
